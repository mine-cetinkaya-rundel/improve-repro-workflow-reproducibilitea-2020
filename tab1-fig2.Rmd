...
Go to <https://forms.gle/EoUJQALNFeZkRgex8> and fill out the form.

```{r}
survey_data <- read_sheet("https://docs.google.com/spreadsheets/d/1_fEIeqCYhaVPYAM4eHiI4gvAaTz6BTQYvV65XP5FGMU/edit?usp=sharing")
names(survey_data) <- c("timestamp", "who", "coffee", "more")

ggplot(survey_data, aes(y = who)) +
  geom_bar()

ggplot(survey_data, aes(x = coffee)) +
